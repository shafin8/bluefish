...
$sql = "INSERT INTO login (fname, lname, email, nid, password, repassword, gender, dob ,user)
VALUES ('".$_POST["fname"]."','".$_POST["lname"]."','".$_POST["email"]."','".$_POST["nid"]."','".$_POST["password"]."','".$_POST["repassword"]."','".$_POST["gender"]."','".$_POST["dob"]."','".$_POST["user"]."')";
