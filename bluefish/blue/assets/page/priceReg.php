       ...
       <ull>
		...
		<div class="registration-form">
			...
			<form  method="post" action="">
				<label>Species</label>
				<input type="text" placeholder="Enter Specis Name" name="Species">
				...
				<label>Production Session</label>
				<input type="text" placeholder="Enter Production Session" name="Production_Session">

				

				
				<input type="submit" value=" Submit " name="submit"/><br />
				<a  href="priceShowE.php">Show</a>
			</form>
		</div>
...
VALUES ('".$_POST["Species"]."','".$_POST["Rate"]."','".$_POST["Size"]."','".$_POST["Production_Session"]."')";
