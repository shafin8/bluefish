       ...
       <ull>
		...
		<div class="registration-form">
			...
			<form  method="post" action="">
				...
				<input type="text" placeholder="Enter Order quantity" name="order_quantity">

				<label>Order Amount</label>
				<input type="text" placeholder="Enter Order amount" name="order_amount">
                <label>Price</label>
				<input type="text" placeholder="Enter price" name="price">

				<label>Status</label>
				<input type="text" placeholder="Enter Order status" name="status">
...
$sql = "INSERT INTO orders (order_quantity,order_amount,price,status,date)
VALUES ('".$_POST["order_quantity"]."','".$_POST["order_amount"]."','".$_POST["price"]."','".$_POST["status"]."','".$_POST["date"]."')";
