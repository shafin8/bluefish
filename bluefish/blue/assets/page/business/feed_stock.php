...
<header>
       ...
       <ull>
		...
		<div class="registration-form">
			<h2>Create new Feed Stock list</h2>

			<form  method="post" action="">
				<label>Feed Category</label>
				<input type="text" placeholder="Enter Feed Category" name="category">

				<label>Feed Quantity</label>
				<input type="text" placeholder="Enter Feed amount" name="amount">
...
<input type="date" id="date-of-birth" name="date">
				...
				<a  href="feed_stock_Show.php">Show</a>
			</form>
		</div>
...
$sql = "INSERT INTO feed_stock (category,amount,date)
VALUES ('".$_POST["category"]."','".$_POST["amount"]."','".$_POST["date"]."')";
