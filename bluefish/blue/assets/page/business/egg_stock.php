...
<header>
       ...
       <ull>
		...
		<div class="registration-form">
			<h2>Create new Egg Stock</h2>

			<form  method="post" action="">
				<label>name</label>
				<input type="text" placeholder="Enter egg Name" name="name">

				<label>amount</label>
				<input type="text" placeholder="Enter egg amount" name="amount">
				...
				<a  href="egg_stock_Show.php">Show</a>
			</form>
		</div>
...
$sql = "INSERT INTO egg_stock (name,amount)
