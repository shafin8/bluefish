...
<header>
       ...
       <ull>
		...
		<div class="registration-form">
			<h2>Create new Feed Consumption list</h2>

			<form  method="post" action="">
				<label>Feed Quantity</label>
				<input type="text" placeholder="Enter Feed Quantity" name="feed_quantity">

				<label>Date of Consumption</label>
				
<input type="date" id="date-of-birth" name="date_of_consumption">
				
				

				
				<input type="submit" value=" Submit " name="submit"/><br />
				<a  href="feed_consumption_Show.php">Show</a>
			</form>
		</div>
...
$sql = "INSERT INTO feed_consumption (feed_quantity, date_of_consumption)
VALUES ('".$_POST["feed_quantity"]."','".$_POST["date_of_consumption"]."')";
