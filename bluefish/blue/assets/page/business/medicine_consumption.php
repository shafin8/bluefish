...
<header>
       ...
       <ull>
		...
		<div class="registration-form">
			<h2>Create new Medicine Consumption list</h2>
...
<input type="date" id="date-of-birth" name="date_of_consumption">
				...
				<input type="text" placeholder="Enter Medicine Type" name="type">
				...
				<a  href="medicine_consumption_Show.php">Show</a>
			</form>
		</div>
...
$sql = "INSERT INTO medicine_consumption (date_of_consumption,type)
VALUES ('".$_POST["date_of_consumption"]."','".$_POST["type"]."')";
